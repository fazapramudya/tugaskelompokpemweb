...
@section('content')
    <div class="create">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Kehadiran untuk {{ $class->class_name }}</h2>
            </div>
        ...
        <div class="w-full mt-8 bg-white rounded">
            <div class="flex items-center justify-between px-6 py-6 pb-0">
                ...
                <h3 class="text-gray-700 uppercase font-bold"> Tanggal: {{ date('Y-m-d') }}</h3>
            </div>

            <div class="w-full px-6 py-6">
                <div class="flex items-center bg-gray-200 rounded-tl rounded-tr">
                    <div class="w-4/12 text-left text-gray-600 py-2 px-4 font-semibold">Nama</div>
                    <div class="w-3/12 text-left text-gray-600 py-2 px-4 font-semibold">Role</div>
                    <div class="w-5/12 text-right text-gray-600 py-2 px-4 font-semibold">Kehadiran</div>
                </div>
