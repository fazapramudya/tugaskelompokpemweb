...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Detail Mahasiswa</h2>
            </div>
        ...
        <div class="mt-8 bg-white rounded">
            <div class="w-full max-w-2xl px-6 py-12">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <span class="text-gray-600 font-bold">{{ $student->nim }}</span>
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                ...
                <div class="w-full px-0 md:px-6 py-12">
                    <div class="flex items-center bg-gray-200">
                        ...
                        <div class="w-1/3 text-left text-gray-600 py-2 px-4 font-semibold">Subjek</div>
                        <div class="w-1/3 text-right text-gray-600 py-2 px-4 font-semibold">Dosen</div>
                    </div>
